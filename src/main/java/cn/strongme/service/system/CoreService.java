...
import cn.strongme.wechat.handler.LogHandler;
import cn.strongme.wechat.handler.MsgFinalHandler;
import cn.strongme.wechat.handler.SubscribeHandler;
import cn.strongme.wechat.handler.UnsubscribeHandler;
...
public class CoreService {
    ...
    @Autowired
    protected MsgFinalHandler msgFinalHandler;
    ...
    public void refreshRouter() {
        ...
        newRouter.rule().async(false).msgType(WxConsts.XmlMsgType.TEXT).handler(this.msgFinalHandler).end();
