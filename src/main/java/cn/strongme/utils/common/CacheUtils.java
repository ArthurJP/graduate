...
/**
 * Created by 阿水 on 2017/9/6 上午12:01.
 */
public class CacheUtils {

    public static final String SYS_CACHE = "sysCache";
    public static final String MOBILE_VALIDATE_CACHE = "mobileValidateCache";

    private static EhCacheCacheManager ehCacheCacheManager = SpringContextHolder.getBean(EhCacheCacheManager.class);
